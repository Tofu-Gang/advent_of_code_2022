...
from src.day_10.crt import CRT
...
def puzzle_01() -> None:
    ...
    :return: None; Answer should be 12840.
    """

    crt = CRT()
    crt.load_instructions()
    print_puzzle_solution(crt.signal_strengths_sum)
...
def puzzle_02() -> None:
    ...
    :return: None; Answer should be ZKJFBJFZ.
    """
