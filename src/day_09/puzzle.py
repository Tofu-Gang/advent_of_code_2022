...
from src.day_09.rope import Rope
...
def puzzle_01() -> None:
    ...
    :return: None; Answer should be 6190.
    """

    rope = Rope(2)
    rope.follow_instructions()
    print_puzzle_solution(rope.tail_visited_count)
...
def puzzle_02() -> None:
    ...
    :return: None; Answer should be 2516.
    """
